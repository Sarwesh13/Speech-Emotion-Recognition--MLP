import os
Root = "C:/Users/Sarwe/OneDrive/Desktop/SER"
os.chdir(Root)
...
model = MLPClassifier(alpha=0.01, batch_size=16, hidden_layer_sizes=(512,), learning_rate='constant', max_iter=300)
...
filename = 'C:/Users/Sarwe/OneDrive/Desktop/SER/saved_model10000.pkl'
with open(filename, 'wb') as file:
    pickle.dump(model, file)
    
# Save the StandardScaler object in pkl format
filename = 'C:/Users/Sarwe/OneDrive/Desktop/SER/scaler.pkl'
with open(filename, 'wb') as file:
...
with open("C:/Users/Sarwe/OneDrive/Desktop/SER/results.txt", "w") as f:
